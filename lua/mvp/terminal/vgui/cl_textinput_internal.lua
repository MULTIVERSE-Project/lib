...
function PANEL:PerformLayout(w, h)
    self:SetFontInternal(mvp.Font(h * .8))
end
...
function PANEL:Paint(w, h)
    self:DrawTextEntryText(color_white, Color(100, 100, 100), Color(150, 150, 150))
end
...
vgui.Register("mvp.TextInputInternal", PANEL, "TextEntry")